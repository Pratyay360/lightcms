...
<BubbleMenu
	...
	class="z-50 flex h-fit w-fit items-center gap-0.5 rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-md"
>
	{#if !isEditing}
	...
	{:else}
		<form
			...
			class="flex w-96 items-center gap-1 p-0.5"
		>
			<Input
